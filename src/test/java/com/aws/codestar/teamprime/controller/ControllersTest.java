...
/**
 * Tests for {@link Controllers}. Modify the tests in order to support your use case as you build your project.
 */
...
public class ControllersTest {
    ...
    private final Controllers controller = new Controllers();
    ...
    /**
     * Basic test to verify the result obtained when calling {@link Controllers#helloWorldGet} successfully.
     */
    @Test
    ...
    /**
     * Basic test to verify the result obtained when calling {@link Controllers#helloWorldPost} successfully.
     */
    @Test
